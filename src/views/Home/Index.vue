  ...
  <div class="home">
    ...
    <div v-for="item in homeList" :key="item.id">
      ...
      <section class="w mt30 clearfix">
        <m-self :title="item.name" v-if="item.type===2">
      ...
      <section class="w mt30 clearfix">
        <m-self :title="item.name" v-if="item.type===3">
          <div slot="content" class="floors">
            ...
            <mall-goods v-for="(o,i) in item.panelContents" :key="i" v-if="o.type===0" :goods='o'></mall-goods>
          </div>
        </m-self>
      </section>
    </div>
...
<script>
import MSelf from "@/components/Self.vue";
...
export default {
  ...
  async created() {
    ...
    if (data.code === 200) {
      ...
      const result = results.find(item => item.type === 0);
      this.banner = result.panelContents;
    }
  }
};
</script>
